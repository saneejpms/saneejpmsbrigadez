            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">
                  {enquiry.estimated_value ? `₹${Number(enquiry.estimated_value).toLocaleString("en-IN")}` : "Not set"}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            ...
            <div className="border-t pt-3 flex justify-between items-center">
              ...
              <span className="font-semibold">₹{totalCosts.toLocaleString("en-IN", { maximumFractionDigits: 2 })}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm font-medium">Revenue</span>
              <span className="font-semibold">₹{revenue.toLocaleString("en-IN", { maximumFractionDigits: 2 })}</span>
            </div>
            <div className="border-t pt-3 flex justify-between items-center">
